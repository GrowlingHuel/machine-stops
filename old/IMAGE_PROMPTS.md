...
> pale timber with Art Nouveau botanical inlay in brass and ivory, a rectangular
> blind covering the porthole entirely on the left wall, the blind made of
> layered amber-coloured material with light attempting its edges from outside
> and failing, a narrow berth with precise geometric bedding, a small reading
> surface with an elaborately bound book, amber light from concealed sources
> in the walls, claustrophobic in the most comfortable sense — everything in
> its correct place, the porthole sealed, another berth just visible through
> a latticed partition suggesting other passengers maintaining their inner
> attention, no exterior present or implied
...
> a purely functional passage with no Art Nouveau treatment whatsoever, the
> contrast between the botanical motifs of the cell wall and the raw darkness
> of the shaft interior is the visual crux of the image, faint cool air
> movement implied by the composition, the male figure standing beside the
> open panel gesturing toward it without pressure, the female figure visible
> at the panel's edge looking into the dark opening, the cell's amber light
> stops cleanly at the shaft entrance and does not penetrate it, the book
