...
> [STYLE FOUNDATION] — Interior of an airship sleeping berth, identical
> architectural style to the other images in this cluster, walls of warm
> pale timber with Art Nouveau botanical inlay in brass and ivory, a circular
> porthole on the left wall with a heavy amber curtain hanging straight down
> from a brass rail and covering the porthole completely — the curtain is
> CLOSED and HANGING STRAIGHT, it is NOT tied back, there are NO tiebacks,
> NO tieback hooks, the curtain hangs perfectly straight covering the porthole
> entirely so no glass is visible, the curtain fabric is thick amber-gold
> gathered fabric hanging from rings on a brass rail, a narrow berth with
> precise geometric bedding visible in the lower portion of the image, a small
> folding reading surface beside the berth with an elaborately bound book
> resting on it, amber light from concealed wall sources, another berth
> visible through a latticed partition to the right, no exterior light, no
> sky, no outside world implied whatsoever
